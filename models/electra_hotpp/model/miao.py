...
class MiaoNet(AtomicModule):
    ...
    def __init__(self,
        ...
        self.energy_readout_node_infos = []
    ...
    def calculate(self,
        ...
        for i, en_equivalent in enumerate(self.en_equivalent_blocks):
            ...
            energy_readout_node_infos.append(node_info[0])
        ...
        energy_readout_node_infos.append(node_info_1[0])
        self.energy_readout_node_infos = energy_readout_node_infos
